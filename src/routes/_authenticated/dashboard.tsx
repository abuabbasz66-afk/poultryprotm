                  ...
                  {open && (
                    <div className="mt-3 space-y-3 border-t border-border pt-3 text-[11px]">
                      <div className="grid grid-cols-2 gap-y-0.5">
                        ...
                        <span className="text-muted-foreground">Bird age</span><span className="text-right">{hasAge(s.room) ? `${flockAge(s.room, today).weeks} wks` : "N/A"}</span>
                      ...
                      <td className="py-3 pr-4">
                        {hasAge(r) ? (
                          <span className="block">
                            <span className="font-medium">{flockAge(r, today).weeks} {flockAge(r, today).weeks === 1 ? "Week" : "Weeks"}</span>
                            <span className="block text-[11px] text-muted-foreground">
                              {flockAge(r, today).days} Days{flockStage(r, today) ? ` · ${flockStage(r, today)}` : ""}
                              {flockAge(r, today).status === "estimated" ? " · estimated start" : ""}
                            </span>
                            {canManageAge && (
                  ...
                  <div className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-muted-foreground">
                        {r.current.toLocaleString()} birds · {r.bird_type || "N/A"} · {hasAge(r) ? `${flockAge(r, today).weeks} weeks` : "Age N/A"}
                      </div>
                    </div>
