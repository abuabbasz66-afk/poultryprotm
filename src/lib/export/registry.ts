...
export const EXPORT_DESCRIPTORS: ExportDescriptor[] = [
  ...
  {
    key: "layer_vaccination",
    label: "Layer vaccination records",
    ...
    roomField: { col: "room_id", kind: "id" },
    flockKind: "layer",
    fileName: "layer_vaccination",
    columns: [
      { header: "Vaccination date", value: (r) => s(r.vaccination_date), type: "date" },
      { header: "Scheduled date", value: (r) => s(r.scheduled_date), type: "date" },
      { header: "Disease", value: (r) => s(r.disease) },
      { header: "Vaccine", value: (r) => s(r.vaccine) },
      { header: "Bird age (days)", value: (r) => n(r.bird_age_days), type: "number" },
      { header: "Birds present", value: (r) => n(r.birds_present), type: "number" },
      { header: "Birds vaccinated", value: (r) => n(r.birds_vaccinated), type: "number" },
      { header: "Batch / lot", value: (r) => s(r.batch_number) },
      { header: "Manufacturer", value: (r) => s(r.manufacturer) },
      { header: "Expiry", value: (r) => s(r.expiry_date), type: "date" },
      { header: "Route", value: (r) => s(r.route) },
      { header: "Administration", value: (r) => s(r.administration_method) },
      { header: "Dose", value: (r) => s(r.dose) },
      { header: "At hatchery", value: (r) => (r.at_hatchery ? "Yes" : "No") },
      { header: "Hatchery", value: (r) => s(r.hatchery_name) },
      { header: "Person responsible", value: (r) => s(r.person_responsible) },
      { header: "Veterinarian", value: (r) => s(r.veterinarian) },
      { header: "Recorded by", value: (r) => s(r.recorded_by_name) },
      { header: "Notes", value: (r) => s(r.notes) },
    ],
    summary: (rows) => [
      { label: "Vaccinations recorded", value: String(rows.length) },
      { label: "Birds vaccinated", value: sum(rows, (r) => n(r.birds_vaccinated)).toLocaleString() },
      {
        label: "Given at hatchery",
        value: String(rows.filter((r) => !!r.at_hatchery).length),
      },
    ],
  },
  {
    key: "layer_vaccination_schedule",
    label: "Layer vaccination schedule",
    table: "flock_vaccination_schedules",
    dateField: "scheduled_date",
    dateKind: "iso",
    permission: "health.read",
    batchField: "batch_id",
    flockKind: "layer",
    fileName: "layer_vaccination_schedule",
    columns: [
      { header: "Scheduled date", value: (r) => s(r.scheduled_date), type: "date" },
      { header: "Age", value: (r) => s(r.age_label) },
      { header: "Disease", value: (r) => s(r.disease) },
      { header: "Vaccine", value: (r) => s(r.vaccine) },
      { header: "Route", value: (r) => s(r.route) },
      { header: "Programme", value: (r) => s(r.programme_name) },
      { header: "Programme version", value: (r) => n(r.programme_version), type: "number" },
      { header: "Calculated from", value: (r) => (s(r.anchor_source) === "hatch" ? "Hatch date" : "Placement date") },
      { header: "Note", value: (r) => s(r.note) },
    ],
    summary: (rows) => [{ label: "Scheduled vaccinations", value: String(rows.length) }],
  },
];
...
export const SECTION_PRESETS: Record<string, { label: string; keys: string[] }> = {
  ...
  vaccination: {
    ...
    keys: ["layer_vaccination", "layer_vaccination_schedule"],
  },
