...
export const NAV_SECTIONS: NavSection[] = [
  ...
  {
    heading: "Sales",
    items: [{ label: "Sales Desk", icon: ShoppingCart, to: "/sales", permission: "sales.read" }],
  },
  {
    heading: "Business",
    items: [
